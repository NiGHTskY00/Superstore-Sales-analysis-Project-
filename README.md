...
4. [Exploratory Data Analysis](#exploratory-data-analysis)
   ...
   - [Customer Loyalty Analysis](#customer-loyalty-analysis)
   - [Shipping Mode Analysis](#shipping-mode-analysis)
   - [Geographical Analysis](#geographical-analysis)
   - [Product Analysis](#product-analysis)
5. [Key Findings](#key-findings)
6. [Notable Visualizations](#notable-visualizations)
...
1. **Missing Postal Codes:**
   - **Issue:** Initially encountered missing values in the Postal Code column, which could lead to incomplete or inaccurate geographical analysis.
   - **Impact:** Missing postal codes could affect location-based insights and demographic targeting.

2. **Data Type Issues:**
   - **Issue:** The Postal Code column was initially stored as a float instead of an integer.
   - **Impact:** Incorrect data types can lead to computational errors and hinder data analysis, particularly in operations involving numerical calculations or comparisons.

3. **Identifying Duplicates:**
   - **Issue:** Ensuring no duplicate records were present in the dataset to maintain data integrity and accuracy.
   - **Impact:** Duplicate records can skew statistical analysis, misrepresent metrics like sales performance, and affect decision-making based on flawed data.

### Solutions and Conclusions
1. **Handling Missing Values:**
   - **Solution:** Filled missing postal codes with 0 to ensure completeness of the dataset.
   - **Conclusion:** This step allowed for more accurate geographical analysis and ensured that all records were usable for location-based insights and customer segmentation.

2. **Correcting Data Types:**
   - **Solution:** Converted the Postal Code column to an integer for accurate data representation.
   - **Conclusion:** By correcting the data type, computational operations and analyses involving postal codes became more reliable and efficient.

3. **Data Verification:**
   - **Solution:** Verified that no duplicate records existed in the dataset.
   - **Conclusion:** Ensuring data integrity through verification minimized the risk of errors in analysis and decision-making processes, providing stakeholders with reliable insights.
